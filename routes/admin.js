...
router.group("/notification", (notification) => {
  ...
  notification.get("/getAdminNotificationList", _notification.getAdminNotificationList);
...
router.group("/statementAccount", (statementAccount) => {
  ...
  statementAccount.post("/statementTransaction/add",_statementAccount.statementTransactionAdd);
  statementAccount.get("/statementTransaction",_statementAccount.statementTransaction);
  statementAccount.put("/updateStatementTransaction/:id",_statementAccount.updateStatementTransaction);
  statementAccount.get("/viewStatementTransaction/:id",_statementAccount.viewStatementTransaction);
  statementAccount.get("/downloadStatementReport",_statementAccount.downloadStatementReport);
