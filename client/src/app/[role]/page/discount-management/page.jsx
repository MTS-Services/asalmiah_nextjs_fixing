...
import { CheckAdminState, formatCurrency, serialNumber } from "../../../../../utils/helper";
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
              <h4 className="mb-md-0">Discount-management</h4>

              <div className="filter_dropdown flex-wrap">
                <Link
                  href={`/admin/page/discount-management/add`}
                  className="btn_theme"
                >
                  Add Discount
                </Link>
                          ...
                          <tr key={data?._id}>
                            ...
                            <td>
                              <div className="d-flex">
                                <Link
                                  href={`/admin/page/discount-management/view/${data?._id}`}
                                >
                                  {" "}
                                  <Button
                                ...
                                <Link
                                  href={`/admin/page/discount-management/edit/${data?._id}`}
                                >
                                  {" "}
                                  <Button
                                    title="Edit"
