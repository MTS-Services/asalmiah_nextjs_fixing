...
import { addCmsDetail } from "../../../../../../services/APIServices";
...
const AddContent = ({ params }) => {
  ...
  const { mutate, error, isPending } = useMutation({
    mutationFn: (payload) => addCmsDetail(payload),
    onSuccess: (resp) => {
    ...
    <div className={toggleVal ? "bodymain fullbody" : "bodymain "}>
      <div className="breadcrum-top mb-4">
        <ul className="d-flex align-items-center gap-2">
          ...
          <li>/</li>
          <li className="text-capitalize">Add Content</li>
        </ul>
      </div>
      <div className="row">
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
              <h4 className="mb-md-0">Add Content</h4>
              <Link
                href={getLinkHref(detail?.roleId, "/page/content-management")}
                className="btn_theme"
              >
