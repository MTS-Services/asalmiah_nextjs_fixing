...
const Add = () => {
  ...
  const { mutate, error, isPending } = useMutation({
    mutationFn: (payload) => ADD_SUBCATEGORY_API(payload),
    onSuccess: (resp) => {
    ...
    validationSchema: yup.object().shape({
      ...
      newPicked: yup
        ...
        .when("subcategory_Img", {
          is: (value) => !value,
          then: () =>
            yup.string().required("Subcategory image is a required field"),
        })
      ...
      <div className={isSlider ? "bodymain" : "bodymain collapsebody"}>
        <div className="breadcrum-top mb-4">
          <ul className="d-flex align-items-center gap-2">
            ...
            <li>/</li>
            <li className="text-capitalize">Add Subcategory</li>
          </ul>
        </div>
        <div className="row">
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h5 className="mb-md-0">Add Subcategory</h5>
                <Link
                  href={`/admin/page/subcategory-management`}
                  className="btn_theme"
                >
