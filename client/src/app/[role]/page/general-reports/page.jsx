...
import { DOWNLOAD_INVOICE_COMPNAY, GET_COMPANY_API } from "../../../../../services/APIServices";
...
const generalreports = () => {
  ...
  const downloadMutation = useMutation({
    mutationFn: ({ startDate, endDate }) => DOWNLOAD_INVOICE_COMPNAY(startDate, endDate),
    onSuccess: (resp) => {
      if (resp?.data?.data) {
      ...
      <div className={isSlider ? "bodymain" : "bodymain collapsebody"}>
        <div className="breadcrum-top mb-4">
          <ul className="d-flex align-items-center gap-2">
            ...
            <li className="text-capitalize">General Report</li>
          </ul>
        </div>
        <div className="row">
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h5 className="mb-md-0">General Report</h5>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="text-end">
                    {(reportsManagementPermissions?.at(0)?.value
                      ?.subNav?.generalReports?.download == true &&
