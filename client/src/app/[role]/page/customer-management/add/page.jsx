...
import "./page.scss";
import { countries, getLinkHref, validEmailPattern } from "../../../../../../utils/helper.js";
...
const AddUser = () => {
  ...
  const addUsers = useMutation({
    ...
    onSuccess: (res) => {
      ...
      resetForm();
      router.push(getLinkHref(detail?.roleId, "/page/customer-management"));
        ...
        <ul className="d-flex align-items-center gap-2">
          ...
          <li>
            ...
            <Link
              ...
              href={getLinkHref(detail?.roleId, "/page/customer-management")}
          ...
          <li>/</li>
          <li className="text-capitalize">add customer management</li>
        </ul>
      </div>
      <div className="row">
