...
const Add = () => {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (payload) => ADD_SPIN_API(payload),
    onSuccess: (resp) => {
  ...
  const {
    ...
    validationSchema: yup.object().shape({
      ...
      value: yup.string().when("spinType", {
        is: (value) => value == 1,
        then: () => yup.string().required("How much percentage is required").test(
          "range",
      ...
      priority: yup
        ...
        .test(
          "range",
          "Priority must be between 0.1 and 100",
          (val) => {
            const num = parseFloat(val);
            return num >= 0.1 && num <= 100;
          }
      ...
      <div className={isSlider ? "bodymain" : "bodymain collapsebody"}>
        <div className="breadcrum-top mb-4">
          <ul className="d-flex align-items-center gap-2">
            ...
            <li>/</li>
            <li className="text-capitalize">Add Fortune Spin</li>
          </ul>
        </div>
        <div className="row">
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h5 className="mb-md-0">Add Fortune Spin</h5>
                <Link href={getLinkHref(detail?.roleId, '/page/fortune-spin')}
                  className="btn_theme">
                  Back
                </Link>
              </div>
                  ...
                  <Row>
                    ...
                    {values?.spinType == "1" ||
                      ...
                      <>
                        ...
                        {values?.spinType === "1" ||
                          values?.spinType === "2" ? ( // Only render if spinType is "1" or "2"
                          <Col lg={6} className="mx-auto">
                            <Form.Group className="mb-4">
                              <Form.Label>
                                Max Cash Back{" "}
