...
const DesignedUserDetails = ({ params }) => {
  ...
  const mutatePersmission = useMutation({
    ...
    onSuccess: (resp) => {
      toastAlert("success", resp?.data?.message);
      // navigate.push(`/admin/page/designed-users`);
    },
  });
  ...
  //   // "offerManagement.add",
  //   // "offerManagement.edit",
  //   // "offerManagement.delete",
  //   "offerManagement.view",
    ...
    <div className={toggleVal ? "bodymain fullbody" : "bodymain "}>
      <div className="breadcrum-top mb-4">
        <ul className="d-flex align-items-center gap-2">
          ...
          <li>/</li>
          <li className="text-capitalize">Designed user detail</li>
        </ul>
      </div>
      <div className="row">
              ...
              <div className="product-detail mb-5 px-md-4 ">
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <AsyncPaginate
                          ...
                          onChange={(selectedOptions) => {
                            handleChange(selectedOptions, "category");
                          }}
                          additional={{
                            page: 1,
                          }}
                    ...
                    {/* {checked.length > 0 && ( */}
                    <button
                      className="btn_theme btn-sm m-3"
                      type="submit"
...
export default DesignedUserDetails;
