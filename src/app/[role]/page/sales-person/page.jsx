...
const CustomerManagement = () => {
  ...
  const getData = async (page, search, state = "") => {
    try {
      const response = await getAllUsers(page, search, state, constant?.SALES);
  ...
  const salesManagementPermissions = getPermissionsByLabel(
          ...
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
              ...
              <div className="filter_dropdown flex-wrap">
                ...
                {(salesManagementPermissions?.at(0)?.value?.subNav?.salesPerson?.add == true &&
                  (detail?.roleId === constant.DESIGNED_USER ||
                    detail?.roleId === constant.PROMOTION_USER)) ||
                  detail?.roleId == constant.ADMIN ? (
                  <Link
                    href={getLinkHref(detail?.roleId, "/page/sales-person/add")}
                    className="btn_theme"
                  >
                    Add Sales Person
                  </Link>
                          ...
                          <tr key={data?._id}>
                            ...
                            <td>
                              <Link
                                href={getLinkHref(
                                  detail?.roleId,
                                  `/page/company-management/view/${data?.companyDetails?._id}`
                                )}
                                target="_blank"
                              >
                            ...
                            <td>
                              <div className="d-flex">
                                {(salesManagementPermissions?.at(0)?.value?.subNav
                                ...
                                {(salesManagementPermissions?.at(0)?.value?.subNav
                                  ...
                                  <Link
                                    href={getLinkHref(
                                      detail?.roleId,
                                      `/page/sales-person/edit/${data?._id}`
                                    )}
                                  >
                                    <Button
                                      title="Edit"
