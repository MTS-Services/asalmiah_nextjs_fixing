...
import { EDIT_VERSION, GET_DETAILS_APPVERSION } from "../../../../../../../services/APIServices";
...
const editForm = () => {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (payload) => EDIT_VERSION(id, payload),
    onSuccess: (resp) => {
  ...
  useQuery({
    ...
    queryFn: async ({ queryKey }) => {
      ...
      const resp = await GET_DETAILS_APPVERSION(id);
      setValues({
        ...values,
        platform: resp?.data?.data?.platform || '',
        latestVersion: resp?.data?.data?.latestVersion || '',
        forceUpdate: resp?.data?.data?.forceUpdate || '',
        releaseNotes: resp?.data?.data?.releaseNotes || '',
      ...
      <div className="bodymain">
        <div className="breadcrum-top mb-4">
          <ul className="d-flex align-items-center gap-2">
            ...
            <li>/</li>
            <li>
              <Link href={getLinkHref(detail?.roleId, "/page/app-version")} className="text-capitalize text-black">
                Smtp
              </Link>
            </li>
            <li>/</li>
            <li className="text-capitalize">Edit App Version</li>
          </ul>
        </div>
        <div className="row">
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h5 className="mb-md-0">Edit App Version</h5>
                <Link href={getLinkHref(detail?.roleId, "/page/app-version")} className="btn_theme">
                  Back
                </Link>
              </div>
