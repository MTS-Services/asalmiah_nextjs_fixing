...
const appVersionForm = () => {
  ...
  const {
    ...
    validationSchema: yup.object().shape({
      ...
      latestVersion: yup.string().required('Latest version is required'),
      forceUpdate: yup.string().required('Force update is required'),
      releaseNotes: yup.string().required('Release notes are required'),
    }),
