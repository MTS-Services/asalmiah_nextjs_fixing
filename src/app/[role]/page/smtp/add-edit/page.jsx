...
import { ADD_SMTP } from "../../../../../../services/APIServices";
...
const SmtpForm = () => {
  ...
  // Mutation for adding SMTP
  let detail = useDetails();

  const { mutate, isPending } = useMutation({
    mutationFn: (payload) => ADD_SMTP(payload), // Only using ADD_SMTP
    onSuccess: (resp) => {
      ...
      <div className="bodymain">
        <div className="breadcrum-top mb-4">
          <ul className="d-flex align-items-center gap-2">
            ...
            <li>/</li>
            <li className="text-capitalize">Add SMTP</li>
          </ul>
        </div>
        <div className="row">
