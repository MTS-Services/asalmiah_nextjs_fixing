...
const CompanyManagement = () => {
  ...
  const getData = async (page, search, state = "") => {
    try {
      const response = await GET_COMPANY_API(page, search, state);
  ...
  const companyManagementPermissions = getPermissionsByLabel(
    ...
    <div className={isSlider ? "bodymain fullbody" : "bodymain "}>
      <div className="breadcrum-top mb-4">
        <ul className="d-flex align-items-center gap-2">
          ...
          <li className="text-capitalize">Company management</li>
        </ul>
      </div>
      <div className="row">
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
              <h4 className="mb-md-0">Company Management</h4>

              <div className="filter_dropdown flex-wrap">
                {(companyManagementPermissions?.at(0)?.value?.subNav?.company.add == true &&
                          ...
                          <tr key={data?._id}>
                            ...
                            <td>
                              <div className="d-flex">
                                {(companyManagementPermissions?.at(0)?.value?.subNav
                                  ?.company.view == true &&
                                  (detail?.roleId === constant.DESIGNED_USER ||
                                    detail?.roleId ===
                                  ...
                                  <Link
                                    href={getLinkHref(
                                      detail?.roleId,
                                      `/page/company-management/view/${data?._id}`
                                    )}
                                  >
                                    {" "}
                                    <Button
                                ...
                                {(companyManagementPermissions?.at(0)?.value?.subNav
                                  ...
                                  <Link
                                    href={getLinkHref(
                                      detail?.roleId,
                                      `/page/company-management/edit/${data?._id}`
                                    )}
                                  >
                                    {" "}
                                    <Button
