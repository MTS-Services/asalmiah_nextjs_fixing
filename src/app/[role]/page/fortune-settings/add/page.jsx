...
import { ADD_SPIN_SETTINGS_API } from "../../../../../../services/APIServices";
...
const Add = () => {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (payload) => ADD_SPIN_SETTINGS_API(payload),
    onSuccess: (resp) => {
      ...
      <div className={isSlider ? "bodymain" : "bodymain collapsebody"}>
        <div className="breadcrum-top mb-4">
          <ul className="d-flex align-items-center gap-2">
            ...
            <li>/</li>
            <li className="text-capitalize">Add Fortune Settings</li>
          </ul>
        </div>
        <div className="row">
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h5 className="mb-md-0">Add Fortune Settings</h5>
                <Link
                  href={getLinkHref(detail?.roleId, "/page/fortune-settings")}
