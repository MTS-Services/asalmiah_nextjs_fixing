...
import { DOWNLOAD_INVOICE_COMPNAY } from "../../../../../services/APIServices";
...
const inactivereports = () => {
  ...
  const downloadMutation = useMutation({
    mutationFn: ({startDate, endDate }) => DOWNLOAD_INVOICE_COMPNAY(startDate, endDate,2),
    onSuccess: (resp) => {
      if (resp?.data?.data) {
    ...
    <>
      ...
      <div className="breadcrum-top mb-4">
        <ul className="d-flex align-items-center gap-2">
          ...
          <li className="text-capitalize">In-Active Reports</li>
        </ul>
      </div>
        <div className="row">
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h5 className="mb-md-0">In-Active Reports</h5>
              ...
              <div className="card-body">
                <form onSubmit={handleSubmit}>
                  ...
                  {(reportsManagementPermissions?.at(0)?.value
                      ?.subNav?.inactiveReports?.download == true &&
...
export default inactivereports;
