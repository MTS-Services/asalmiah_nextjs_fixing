...
const PromotionUsers = () => {
  ...
  const getData = async (page, search, state = "") => {
    try {
      const response = await getAllUsers(page, search, state, constant?.PROMOTION_USER);
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
              <h4 className="mb-md-0">Promotion Users</h4>
              <div className="filter_dropdown flex-wrap">
                ...
                <Link
                  href={`/admin/page/promotion-users/add`}
                  className="btn_theme"
                >
                  Add Promotion Users
                </Link>
                          ...
                          <tr key={data?._id}>
                            ...
                            <td>
                              <div className="d-flex">
                                <Link
                                  href={`/admin/page/promotion-users/${data?._id}`}
                                >
                                  <Button
                                    title="View"
                                ...
                                <Link
                                  href={`/admin/page/promotion-users/edit/${data?._id}`}
                                >
                                  <Button
                                    title="Edit"
