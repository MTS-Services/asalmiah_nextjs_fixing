...
const AddPromotionUsers = () => {
  ...
  const addUsers = useMutation({
    ...
    onSuccess: (res) => {
      ...
      resetForm();
      router.push("/admin/page/promotion-users");
    },
  });
      ...
      <div className="breadcrum-top mb-4">
        <ul className="d-flex align-items-center gap-2">
          ...
          <li>
            {" "}
            <Link
              href="/admin/page/promotion-users"
          ...
          <li>/</li>
          <li className="text-capitalize">Add Promotion User</li>
        </ul>
      </div>
      <div className="row">
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
              <h5 className="mb-0">Add Promotion User</h5>
              <Link href={`/admin/page/promotion-users`} className="btn_theme">
                Back
              </Link>
            </div>
...
export default AddPromotionUsers;
